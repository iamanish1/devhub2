  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        {/* Filters Sidebar */}
        <aside className={`${mobileFilterOpen ? 'block' : 'hidden'} md:block w-full md:w-[300px] bg-[#1E1E1E] p-6 md:min-h-screen overflow-auto transition-all duration-300 ease-in-out`}>
          ...
          <div className="space-y-6">
            ...
            <div className="filter-group">
              <label className="block text-[#00A8E8] mb-2 font-medium">Technology Stack</label>
            ...
            {/* Budget Range Filter */}
            <div className="filter-group">
              <label className="block text-[#00A8E8] mb-2 font-medium">Project Budget</label>
              <select className="w-full bg-[#2A2A2A] border border-[#444] rounded-lg p-3 focus:border-[#00A8E8] focus:ring-1 focus:ring-[#00A8E8] focus:outline-none transition-colors">
            ...
            <div className="filter-group">
              <label className="block text-[#00A8E8] mb-2 font-medium">Experience Level</label>
              <select className="w-full bg-[#2A2A2A] border border-[#444] rounded-lg p-3 focus:border-[#00A8E8] focus:ring-1 focus:ring-[#00A8E8] focus:outline-none transition-colors">
