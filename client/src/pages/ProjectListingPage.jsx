...
const ProjectListingPage = () => {
  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      case 1:
        ...
        if (!formData.Project_Contributor || formData.Project_Contributor <= 0) {
          errors.Project_Contributor = "Number of contributors must be greater than 0";
        }
        if (!formData.Project_Number_Of_Bids || formData.Project_Number_Of_Bids <= 0) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("project_starting_bid", formData.project_starting_bid);
      formDataToSend.append("Project_Contributor", formData.Project_Contributor);
      formDataToSend.append("Project_Number_Of_Bids", formData.Project_Number_Of_Bids);
        ...
        <div className="max-w-5xl mx-auto mt-10">
           ...
           <div className="text-center mb-12 animate-fade-in">
             ...
             <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-6">
               Transform your ideas into reality. Find the perfect team to bring your vision to life.
             </p>
              ...
              <div className="flex flex-wrap justify-center items-center gap-6 mb-8">
                ...
                >
                  ...
                  <span className="text-sm text-gray-300 group-hover:text-white">SSL Secured</span>
                  <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  ...
                  <span className="text-sm text-gray-300 group-hover:text-white">NDA Protected</span>
                  <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                </div>
                ...
                >
                  ...
                  <span className="text-sm text-gray-300 group-hover:text-white">Verified Teams</span>
                  <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-white mb-3">SSL Security & Data Protection</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
                            <div>
                              <h4 className="font-medium text-green-400 mb-2">Encryption Standards</h4>
                            ...
                            <div>
                              <h4 className="font-medium text-blue-400 mb-2">Infrastructure Security</h4>
                              <ul className="space-y-1">
                                <li>• Cloud-based infrastructure with enterprise-grade security</li>
                  ...
                  <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-6 rounded-xl border border-blue-500/20 animate-fade-in">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-white mb-3">NDA Protection & Legal Safeguards</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
                            <div>
                              <h4 className="font-medium text-blue-400 mb-2">Automatic NDA System</h4>
                              <ul className="space-y-1">
                                <li>• Legally binding NDAs generated automatically</li>
                                <li>• Customizable confidentiality terms</li>
                                <li>• Digital signature verification system</li>
                                <li>• Legal compliance with international standards</li>
                              </ul>
                            </div>
                            <div>
                              <h4 className="font-medium text-purple-400 mb-2">Intellectual Property Protection</h4>
                              <ul className="space-y-1">
                                ...
                                <li>• Professional legal review of all agreements</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 p-6 rounded-xl border border-purple-500/20 animate-fade-in">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-white mb-3">Team Verification & Quality Assurance</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
                            <div>
                              <h4 className="font-medium text-purple-400 mb-2">Verification Process</h4>
                              <ul className="space-y-1">
                            ...
                            <div>
                              <h4 className="font-medium text-pink-400 mb-2">Quality Standards</h4>
                              <ul className="space-y-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <div className="bg-gradient-to-br from-[#1a1a1a] to-[#232323] p-6 rounded-xl border border-gray-700 text-center">
                  <div className="text-3xl font-bold text-[#00A8E8] mb-2">Launch Ready</div>
                  <div className="text-sm text-gray-400">Platform Fully Developed</div>
                </div>
                <div className="bg-gradient-to-br from-[#1a1a1a] to-[#232323] p-6 rounded-xl border border-gray-700 text-center">
                  <div className="text-3xl font-bold text-[#00A8E8] mb-2">Beta Tested</div>
                  <div className="text-sm text-gray-400">Security Verified</div>
                </div>
                <div className="bg-gradient-to-br from-[#1a1a1a] to-[#232323] p-6 rounded-xl border border-gray-700 text-center">
                  <div className="text-3xl font-bold text-[#00A8E8] mb-2">Live Support</div>
          ...
          <div className="mb-12">
                ...
                <div key={step.id} className="flex items-center">
                  ...
                  {index < steps.length - 1 && (
                    <div className={`flex-1 h-1 mx-4 transition-all duration-500 ${
                      currentStep > step.id ? "bg-gradient-to-r from-[#0062E6] to-[#00A8E8]" : "bg-gray-700"
                    }`}></div>
                  )}
                </div>
              ))}
           ...
           <div className="bg-gradient-to-br from-[#1a1a1a] to-[#232323] rounded-xl shadow-2xl overflow-hidden border border-gray-700">
             ...
             <form onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="p-8 md:p-12">
              {/* Step 1: Project Basics */}
              {currentStep === 1 && (
                <div className="animate-slide-in-right space-y-8">
                  <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-white mb-2">Project Basics</h2>
                    <p className="text-gray-300">Let's start with the fundamentals of your project</p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="group">
                        ...
                        {validationErrors.project_duration && (
                          <p className="text-red-400 text-sm mt-1">{validationErrors.project_duration}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="group">
                        ...
                        {validationErrors.Project_Contributor && (
                          <p className="text-red-400 text-sm mt-1">{validationErrors.Project_Contributor}</p>
                        )}
                      </div>
                      ...
                      <div className="group">
                        ...
                        {validationErrors.Project_Number_Of_Bids && (
                          <p className="text-red-400 text-sm mt-1">{validationErrors.Project_Number_Of_Bids}</p>
                        )}
                      </div>
                    </div>
              ...
              {currentStep === 2 && (
                <div className="animate-slide-in-right space-y-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-300">Tell us more about your vision and requirements</p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="group">
                      ...
                      {validationErrors.Project_Features && (
                        <p className="text-red-400 text-sm mt-1">{validationErrors.Project_Features}</p>
                      )}
                    ...
                    <div className="group">
                      ...
                      {validationErrors.Project_looking && (
                        <p className="text-red-400 text-sm mt-1">{validationErrors.Project_looking}</p>
                      )}
                    </div>
                  </div>
                </div>
              ...
              {currentStep === 3 && (
                <div className="animate-slide-in-right space-y-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-300">Almost there! Just a few more things to complete</p>
                  </div>
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 p-4 rounded-lg border border-green-500/20">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <h3 className="font-semibold text-white mb-2">Your Data is Protected</h3>
                              <ul className="text-sm text-gray-300 space-y-1">
                                <li>• Industry-standard encryption for all project data</li>
                                <li>• Secure data handling practices implemented</li>
                                <li>• Reliable cloud infrastructure for data storage</li>
                                <li>• Built with security best practices from day one</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 p-4 rounded-lg border border-purple-500/20">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <h3 className="font-semibold text-white mb-2">Intellectual Property Protection</h3>
                              <ul className="text-sm text-gray-300 space-y-1">
                                <li>• Built-in NDA system for all project collaborations</li>
                                <li>• Your IP rights are clearly defined and protected</li>
                                <li>• Confidentiality agreements integrated into the platform</li>
                                <li>• Legal framework designed to protect your innovations</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                         ...
                         <div className="flex items-start space-x-3">
                           ...
                           <div>
                             ...
                             <p className="text-sm text-gray-400">
                               By submitting this project, you agree to our terms and conditions. Your project will be reviewed by our expert team before going live to ensure quality and security standards.
                             </p>
                           </div>
                         </div>
                       </div>
            ...
            <div className="mt-16 text-center">
              <div className="bg-gradient-to-r from-[#0062E6]/20 to-[#00A8E8]/20 p-8 rounded-xl border border-gray-700">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Our platform is ready and waiting for innovative projects like yours. Start building your dream team today with our secure, professional development platform.
                </p>
