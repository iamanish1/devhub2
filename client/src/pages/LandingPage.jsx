  ...
  return (
    <>
      ...
      <div className="bg-[#121212] text-white font-sans overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              {[
                {
                  title: "List Projects",
                  description: "Project owners list their projects and find contributors.",
                  icon: (
                ...
                },
                {
                  ...
                  description: "Junior developers bid to contribute and gain experience.",
                  icon: (
                    <svg className="w-12 h-12 mx-auto mb-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {
                  title: "Earn & Learn",
                  description: "Contributors earn for their work and build their portfolios.",
                  icon: (
                    <svg className="w-12 h-12 mx-auto mb-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              {[
                ...
                >
                  ...
                  <p className="text-gray-300 mt-4 mb-6 leading-relaxed">"{testimonial.text}"</p>
              ...
              {[
                {
                  ...
                  answer: "Simply sign up, browse projects, and place your bid. You can specify your rate, delivery timeline, and how your skills match the project requirements."
                },
                {
                  question: "Are payments secure?",
                  answer: "Yes! We use escrow to ensure secure transactions. Funds are only released to you when the project owner is satisfied with your work."
                },
                {
                  question: "How is the mentorship structured?",
                  answer: "Project owners can choose to offer mentorship as part of their projects. You'll receive code reviews, feedback, and guidance throughout the development process."
                },
                {
                  question: "Can I work on projects part-time?",
                  answer: "Absolutely! Many projects on DevHubs are flexible and can be completed on a part-time basis. You can set your availability when placing bids."
                }
              ].map((faq, index) => (
        ...
        >
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemFadeIn}
            >
              Join DevHubs and take your career to the next level. Connect with mentors, build your portfolio, and earn while you learn.
            </motion.p>
        ...
        {/* Footer */}
        <footer className="py-8 px-4 md:px-8 bg-[#0a0a0a]">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-bold text-xl mb-4">DevHubs</h3>
              <p className="text-gray-400">Connecting junior developers with real-world opportunities.</p>
            </div>
              ...
              <div key={i}>
                ...
                <ul className="space-y-2">
                  {["Link 1", "Link 2", "Link 3"].map((link, j) => (
                    <li key={j}><a href="#" className="text-gray-400 hover:text-blue-400 transition">{link}</a></li>
                  ))}
                </ul>
              </div>
            ))}
          ...
          <div className="max-w-6xl mx-auto mt-8 pt-8 border-t border-gray-800 text-center text-gray-500">
            <p>© 2025 DevHubs. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </>
